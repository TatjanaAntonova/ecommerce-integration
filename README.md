...
```sh
grep -rl 'columbus' ./ | xargs sed -i '' 's/columbus/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with columbus
...
Want to contribute? Ping us on `columbus` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/columbus.git
    cd columbus
    ```
...
- [columbus integration Documentation](https://docs.vuestorefront.io/columbus)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `columbus` channel on [our Discord](discord.vuestorefront.io).
